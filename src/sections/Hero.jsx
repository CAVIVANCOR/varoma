      ...
      style={{backgroundImage: `url(${backgroundImage})`}}>
        <motion.div 
          ...
          className='lg:w-[60%] w-full flex flex-col justify-center items-start lg:gap-8 gap-4'>
            ...
            <motion.h1 variants={slideUpVariants} className='text-white uppercase text-[50px] font-bold text-xl'>Lider en Electrificación Industrial</motion.h1>
        ...
        <div className='w-[40%] flex flex-col justify-end items-end'>
          ...
          whileInView="visible"
          variants={zoomInVariants}
          src={heroimg} alt="heroimg" className='lg:h-[600px] h-[300px] lg:mb-[-100px]' />
        </div>
    </div>
  )
}
